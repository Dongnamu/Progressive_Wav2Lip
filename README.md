# Note
This repository contains the modified version of https://github.com/Rudrabha/Wav2Lip to enable progressive training. It is implemented for audio driven human lip manipulation project.
